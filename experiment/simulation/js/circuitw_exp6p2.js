...
if(image1.getAttribute('src')=="images/off.png" && image3.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/off.png" && image16.getAttribute('src')=="images/on.png" ){
...
else if(image1.getAttribute('src')=="images/on.png" ){
...
else if(image11.getAttribute('src')=="images/on.png" ){
    document.getElementById("msg").innerHTML = 'Please connect GND properly (Make GND to LOW for lower order comparator circuit) ';
document.getElementById("showalt").style.visibility = 'visible';
document.getElementById("msg").style.color="red";
}

else if(image1.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/on.png"){
        document.getElementById("msg").innerHTML = 'Please connect GND properly (Make GND to LOW) ';
        document.getElementById("showalt").style.visibility = 'visible';
		document.getElementById("msg").style.color="red";
       
    }
 else   if(image1.getAttribute('src')=="images/on.png" && image3.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/on.png" && image16.getAttribute('src')=="images/on.png" ){
        document.getElementById("msg").innerHTML = 'Please connect GND properly (Make GND to LOW)';
        document.getElementById("showalt").style.visibility = 'visible';
        document.getElementById("msg").style.color="green";
    }
    else   if(image1.getAttribute('src')=="images/off.png" && image3.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/on.png" && image16.getAttribute('src')=="images/on.png" ){
        document.getElementById("msg").innerHTML = 'Please connect GND properly (Make GND to LOW for lower order comparator circuit)';
        document.getElementById("showalt").style.visibility = 'visible';
        document.getElementById("msg").style.color="green";
    }
    else   if(image1.getAttribute('src')=="images/on.png" && image3.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/on.png" && image16.getAttribute('src')=="images/off.png" ){
        document.getElementById("msg").innerHTML = 'Please connect GND properly (Make GND to LOW for higher order comparator circuit)';
        document.getElementById("showalt").style.visibility = 'visible';
        document.getElementById("msg").style.color="green";
    }
    else   if(image1.getAttribute('src')=="images/off.png" && image3.getAttribute('src')=="images/on.png" && image11.getAttribute('src')=="images/off.png" && image16.getAttribute('src')=="images/off.png" ){
        document.getElementById("msg").innerHTML = 'Please connect VCC properly (Make VCC to HIGH for lower order comparator circuit)';
        document.getElementById("showalt").style.visibility = 'visible';
        document.getElementById("msg").style.color="green";
    }
    else   if(image1.getAttribute('src')=="images/off.png" && image3.getAttribute('src')=="images/off.png" && image11.getAttribute('src')=="images/off.png" && image16.getAttribute('src')=="images/on.png" ){
